...
<html lang="en">
    ...
    <head>
        ...
        <?php 
            ...
            // JOIN을 활용하여 item_like와 product 데이터를 가져오기
            $sql = "
                SELECT p.* 
                FROM item_like il
                JOIN product p ON il.l_itemidx = p.idx
                WHERE il.l_user = '$userid'
            ";
    ...
    <body>
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">찜 목록</h1>
        </div>
        ...
        <div class="container-fluid fruite py-5">
            <div class="container py-5">
                <h1 class="mb-4">Fresh Like Shop</h1>
                <div class="row g-4">
                    <div class="col-lg-12">
                        <div class="row g-4">
                            <div class="col-6"></div>
                                        ...
                                        <a href="detail.php?idx=<?=$row['idx']?>">
                                            <div class="rounded position-relative fruite-item">
                                                <div class="fruite-img">
                                                    <img src="../product/<?=$row['file']?>" class="img-fluid w-100 rounded-top" alt="" >
                                                </div>
                                                ...
                                                <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                    ...
                                                    <div class="d-flex justify-content-between flex-lg-wrap">
                                                        <p class="text-dark fs-5 fw-bold mb-0"><?= number_format($row['price'])?> 원</p>
